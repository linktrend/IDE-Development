...
- push the branch as a **checkpoint** (no PR). When the issue is finished, mark review-ready via completion gate — the Phase Packager/Coordinator (`scripts/gitops/packager_coordinator.py`) opens the Phase PR. Do not self-merge.
