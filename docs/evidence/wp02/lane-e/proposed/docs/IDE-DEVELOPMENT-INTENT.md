...
| Real consumer rollout during Work Packet 1 / Work Packet 2 | Deferred. Inventory + order live in `docs/GITOPS-CONSUMER-ROLLOUT.md`; each consumer needs separate Principal approval. Work Packet 2 does not authorize consumer mutation; Work Packet 3 owns publication decisions. |
| Git tag / GitHub Release as part of WP1 / WP2 | WP1 may build a release-candidate **archive** for proof; WP2 does not publish tag/Release; tag/Release publication belongs to later approval (WP03 boundary). |
...
| `docs/GITOPS-CONSUMER-ROLLOUT.md` | Consumer inventory; rollout deferred / separately approval-gated; WP02 lineage vs WP03 publication boundaries. |
