...
- **Consumer rollout:** Deferred and separately Principal-gated. Work Packet 2 (Issue #68, in progress) is lineage + live readiness (checkpoint only). Work Packet 3 is integration/publication. See `docs/GITOPS-CONSUMER-ROLLOUT.md`.
...
| WP1/WP2 publishes a GitHub Release / tag | WP1 builds an RC **archive** for proof only; WP2 does not publish; tag/Release is WP03/approval-gated |
