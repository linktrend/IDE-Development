...
- `PRD.md`
- `LIVING-DOCUMENT.md`
- recorded Principal decision covering PRD and Living Document
...
- acceptance-criterion coverage map from every Living Document criterion to one or more Issues.
...
- every Living Document criterion has real evidence;
...
- independent verifier checks the full integrated application against every Living Document criterion;
...
6. reject Module 4 completion with any unmet Living Document criterion;
...
core/templates/LIVING-DOCUMENT.md
...
- Principal decisions;
- Living Document path and SHA256;
...
- Module 1: `grill-with-docs` + gstack `spec` + `to-spec`, plus explicit Living Document authoring and human gate.
...
- Module 1 test proves PRD + Living Document + human gate.
...
- `packages/module1-intake/src/living-document.ts`
...
1. Module 1 entry classification, interview fixture, Intent, PRD, Living Document, simulated recorded Principal approval.
