...
{"schemaVersion":1,"fastWorkflowName":"Linktrend Fast Checks","ciWorkflowName":"${name} CI","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"github-hosted"}
JSON
...
printf '%s\n' '{"schemaVersion":1,"ciWorkflowName":"Legacy CI","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"github-hosted"}' >"$legacy/.github/linktrend-gitops-consumer.json"
...
printf '%s\n' '{"schemaVersion":1,"ciWorkflowName":"Legacy CI","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"linktrend-private-macos-arm64"}' >"$private_legacy/.github/linktrend-gitops-consumer.json"
...
for legacy_ref in cea9660bb507dec665d020dcf105ac1df67d8edc 2c81d37c0a7ab948dc9d9bf08b0ba917d3949d38; do
  ...
  printf '%s\n' '{"schemaVersion":1,"ciWorkflowName":"Upgrade CI","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"github-hosted"}' >"$upgrade_repo/.github/linktrend-gitops-consumer.json"
...
for invalid in \
  '{"schemaVersion":1,"fastWorkflowName":"","ciWorkflowName":"CI","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"github-hosted"}' \
  '{"schemaVersion":1,"fastWorkflowName":"Other Fast","ciWorkflowName":"CI","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"github-hosted"}' \
  '{"schemaVersion":1,"fastWorkflowName":"Linktrend Fast Checks","ciWorkflowName":"","branchPolicyWorkflowName":"Branch Source Policy","bugbotCheckName":"Linktrend Review Gate","reviewGateCheckName":"Linktrend Review Gate","bugbotProviderCheckName":"Linktrend Review Gate","runnerType":"github-hosted"}'; do
