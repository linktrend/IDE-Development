...
This repository is **IDE Development** — the shared AI development core (version **v2.2.0**) used across **Cursor** and **Codex**.
...
Details: [`docs/runbooks/release-candidate.md`](docs/runbooks/release-candidate.md) and [`docs/runbooks/streamlined-delivery.md`](docs/runbooks/streamlined-delivery.md).
