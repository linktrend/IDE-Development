...
- canonical knowledge asset: `../core/`
...
- Do not rewrite doctrine, command names, or internal references during normal use.
- Use progressive disclosure rather than loading every layer.

This file is packaging guidance only.
